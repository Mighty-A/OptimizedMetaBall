...
#define MAX_RAY_RECURSION_DEPTH 8  // ~ primary rays + reflections + shadow rays from reflected geometry.
...
static const XMFLOAT4 WaterReflectance = XMFLOAT4(0.020f, 0.020f, 0.020f, 1.0f);
